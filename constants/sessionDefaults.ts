...
import { role_access } from "@/lib/supabase/enums";
...
export type app_metadata = {
    ...
    provider?: "google" | "apple" | "email" | "phone" | null;
...
export type access_level = typeof role_access //"guest" | "member" | "manager" | "admin";
...
export type session = {
    ...
    vendors?: vendor[] | null | undefined; // array of vendor_id from public.suppliers
