 ...
 */
export const { light, dark } = globalStyles;
export const tintColorLight = globalStyles.light.accent
export const tintColorDark = globalStyles.dark.accent;
...
class ColorHelper {
  ...
  get(propertyPath: string) {
    ...
    let value = Colors[this.theme as "light" | "dark"];
